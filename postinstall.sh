...
echo "$ADD_DOMAINS" | tr "," "\n" | while read line; do echo "docker exec -t postfixadmin php /postfixadmin/scripts/postfixadmin-cli.php domain add $line"; done

# add email accounts used by system senders (drive, ...)
